...
team add purple {"text":"PURPLE","color":"light_purple"}
...
team add dark_yellow {"text":"Dark Yellow","color":"gold"}
team modify dark_yellow color gold
team modify dark_yellow friendlyFire false
